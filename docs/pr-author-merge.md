# Lab 07 — author-merged PR, independent Azure approval

**Scope: Lab 07 only.** The participant can inspect and merge their own source PR
...
The separate **dev-plan / dev-apply deployment approvals remain independent**.
