...
Obtain instructor go-ahead after the applicable real deployment and fresh `followup`. Reconfirm [all live prerequisites](activity-02.md) and [instructor preflight](../docs/instructor-preflight.md): unchanged protected main, distinct identities, private backend/container lease access, state concurrency, restricted allowed-workflow runner, main-only environments, independent review, no self-review or administrator bypass.
