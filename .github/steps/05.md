...
| Workflow | [cleanup.yml](../workflows/cleanup.yml): **Trusted dev cleanup (explicit owner authorization required)**; [non-runnable reference](../../solutions/cleanup.yml) |
...
| `gh workflow run` | Request the dedicated [cleanup workflow](../workflows/cleanup.yml), not delivery or local Terraform |
...
verify that [AgentAlvine's completion-event subscription](../workflows/agentalvine.yml)
