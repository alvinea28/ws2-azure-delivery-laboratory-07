...
If you performed [Step 3's benign HCL update](03.md), use that latest deployed SHA and verify its actual Azure tag/property change and unchanged IDs first. An earlier baseline no-change does not prove the update converged. Output IDs alone are not configuration evidence.
...
**Next:** [Step 5: mandatory separately authorized cleanup](05.md). No-change alone is not deletion authorization.
